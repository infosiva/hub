...
export const SITES: Site[] = [
  ...
  },
  {
    id: "quicktech",
    name: "QuickTech AI",
    url: "https://quicktech-nine.vercel.app",
  ...
  // ── Finance (new) ─────────────────────────────────────────────
  {
    ...
    vercelProject: "billslash",
    emoji: "💸",
    category: "Finance",
    tagline: "AI bill negotiator — cut your subscriptions in 60 seconds",
    accentColor: "#0284c7",
    tips: [
    ...
    competitors: [
      { name: "Billfix", url: "https://billfix.com", strength: "Human negotiators, results-based" },
      { name: "Trim", url: "https://asktrim.com", strength: "Subscription cancellation + negotiation" },
      { name: "Rocket Money", url: "https://rocketmoney.com", strength: "All-in-one finance + cancellation" },
    ],
    featureToggles: [
      { key: "no_auth_estimate", label: "Free Estimate", description: "Get savings estimate without account", defaultOn: true },
      { key: "provider_list", label: "Provider List", description: "Supported telecom/utility providers", defaultOn: true },
      { key: "auto_negotiate", label: "Auto Negotiate", description: "AI sends negotiation email on your behalf", defaultOn: false },
    ],
    stack: [
      { label: "Framework", value: "Next.js 15 App Router" },
      { label: "AI Model", value: "llama-3.1-8b-instant (Groq)" },
  ...
  // ── Career (new) ──────────────────────────────────────────────
  {
    id: "firstline",
    name: "Firstline",
    url: "https://firstline.so",
    vercelProject: "firstline",
    emoji: "🏗️",
    category: "Career",
    tagline: "AI shift scheduling for frontline workers",
    accentColor: "#0ea5e9",
    tips: [
    ...
    competitors: [
      { name: "Deputy", url: "https://deputy.com", strength: "Market leader, 300k+ businesses" },
      { name: "When I Work", url: "https://wheniwork.com", strength: "Shift messaging + scheduling combo" },
      { name: "Sling", url: "https://getsling.com", strength: "Free tier, hospitality focus" },
    ],
    featureToggles: [
      { key: "shift_demo", label: "Shift Demo", description: "Interactive shift schedule demo on homepage", defaultOn: true },
      { key: "sms_notifications", label: "SMS Notifications", description: "Shift change alerts via SMS", defaultOn: false },
      { key: "ai_scheduling", label: "AI Scheduling", description: "AI auto-fills shifts based on availability", defaultOn: true },
    ],
    stack: [
      { label: "Framework", value: "Next.js 15 App Router" },
      { label: "AI Model", value: "llama-3.1-8b-instant (Groq)" },
      { label: "Design", value: "Canvas → Emil polish" },
      { label: "Skills used", value: "/design-html, /animate, /interface-design" },
    ],
  },
  {
    id: "airesumescreener",
    ...
    vercelProject: "ai-resume-screener",
    emoji: "🔎",
    category: "Career",
    tagline: "Screen 100 resumes in 60 seconds with AI",
    accentColor: "#7c3aed",
    tips: [
    ...
    competitors: [
      { name: "Greenhouse", url: "https://greenhouse.com", strength: "ATS market leader, enterprise trust" },
      { name: "Workday Recruiting", url: "https://workday.com", strength: "HR suite integration, Fortune 500" },
      { name: "Fetcher", url: "https://fetcher.ai", strength: "AI candidate sourcing + screening combo" },
    ],
    featureToggles: [
      { key: "demo_screen", label: "Demo Screen", description: "Try with sample resumes, no login", defaultOn: true },
      { key: "bulk_upload", label: "Bulk Upload", description: "Upload 100+ resumes as ZIP", defaultOn: false },
      { key: "ats_export", label: "ATS Export", description: "Export ranked list to ATS format", defaultOn: false },
    ],
    stack: [
      { label: "Framework", value: "Next.js 15 App Router" },
      { label: "AI Model", value: "llama-3.1-8b-instant (Groq)" },
  ...
  },
  {
    id: "outreachcrm",
    name: "OutreachCRM",
    url: "https://outreach-crm.vercel.app",
    vercelProject: "outreach-crm",
    emoji: "📬",
    category: "Career",
    tagline: "AI-powered outreach CRM for recruiters & sales",
    accentColor: "#0284c7",
    tips: [
    ...
    competitors: [
      { name: "Outreach.io", url: "https://outreach.io", strength: "Enterprise sales engagement platform" },
      { name: "Apollo.io", url: "https://apollo.io", strength: "Data + sequencing combo, 275M contacts" },
      { name: "Lemlist", url: "https://lemlist.com", strength: "Personalised email + LinkedIn combo" },
    ],
    featureToggles: [
      { key: "demo_pipeline", label: "Demo Pipeline", description: "CRM pipeline view without account", defaultOn: true },
      { key: "ai_email_draft", label: "AI Email Draft", description: "AI drafts personalised outreach email", defaultOn: true },
      { key: "linkedin_import", label: "LinkedIn Import", description: "Import prospect from LinkedIn URL", defaultOn: false },
    ],
    stack: [
      { label: "Framework", value: "Next.js 16 App Router" },
      { label: "Auth", value: "NextAuth v5" },
  ...
  // ── Health (new) ──────────────────────────────────────────────
  {
    ...
    vercelProject: "playsmart",
    emoji: "⚽",
    category: "Health",
    tagline: "AI sports coaching drills — personalised training plans",
    accentColor: "#16a34a",
    tips: [
    ...
    competitors: [
      { name: "Hudl", url: "https://hudl.com", strength: "Video analysis, coach market dominance" },
      { name: "TrainingPeaks", url: "https://trainingpeaks.com", strength: "Endurance sports, structured plans" },
      { name: "CoachNow", url: "https://coachnow.io", strength: "Coach-athlete communication platform" },
    ],
    featureToggles: [
      { key: "drill_demo", label: "Drill Demo", description: "Generate drill plan without account", defaultOn: true },
      { key: "video_drills", label: "Video Drills", description: "AI-generated video for each drill (fal.ai)", defaultOn: false },
      { key: "weekly_plan", label: "Weekly Plan", description: "Email weekly training plan", defaultOn: false },
    ],
    stack: [
      { label: "Framework", value: "Next.js 15 App Router" },
      { label: "AI Model", value: "llama-3.1-8b-instant (Groq)" },
      { label: "Video Gen", value: "fal.ai background video (Wan)" },
      { label: "Design", value: "Canvas → Emil polish" },
      { label: "Skills used", value: "/design-html, /animate, /fal-generate" },
    ],
  },
  ...
  // ── Social (new) ──────────────────────────────────────────────
  {
    ...
    emoji: "✨",
    category: "Social",
    tagline: "AI social content sparks — viral posts in seconds",
    accentColor: "#e11d48",
    tips: [
    ...
    competitors: [
      { name: "Buffer", url: "https://buffer.com", strength: "Scheduling + analytics, creator trust" },
      { name: "Taplio", url: "https://taplio.com", strength: "LinkedIn-specific AI content" },
      { name: "Postwise", url: "https://postwise.ai", strength: "Twitter/X viral post AI" },
    ],
    featureToggles: [
      { key: "no_auth_generate", label: "Free Generate", description: "Generate posts without account", defaultOn: true },
      { key: "platform_preview", label: "Platform Preview", description: "Show post on Twitter/LinkedIn/Instagram", defaultOn: true },
      { key: "tone_selector", label: "Tone Selector", description: "Choose from professional/casual/viral tones", defaultOn: true },
    ],
    stack: [
      { label: "Framework", value: "Next.js 15 App Router" },
      { label: "AI Model", value: "llama-3.1-8b-instant (Groq)" },
      { label: "Design", value: "Canvas → Emil polish (white + rose)" },
      { label: "Skills used", value: "/design-html, /animate, /social-content" },
    ],
  },
  ...
  // ── AI Tools (new) ────────────────────────────────────────────
  {
    ...
    vercelProject: "photorestore",
    emoji: "🖼️",
    category: "AI Tools",
    tagline: "AI photo restoration — bring old photos back to life",
    accentColor: "#b45309",
    tips: [
    ...
    competitors: [
      { name: "Remini", url: "https://remini.ai", strength: "Mobile-first, 100M+ downloads" },
      { name: "MyHeritage Photo", url: "https://myheritage.com", strength: "Genealogy context + photo restore combo" },
      { name: "Let's Enhance", url: "https://letsenhance.io", strength: "AI upscaling, professional quality" },
    ],
    featureToggles: [
      { key: "free_restore", label: "Free Restore", description: "1 free restoration without account", defaultOn: true },
      { key: "colorize", label: "Colorize", description: "Add color to black-and-white photos", defaultOn: true },
      { key: "batch_restore", label: "Batch Restore", description: "Restore up to 20 photos at once (Pro)", defaultOn: false },
    ],
    stack: [
      { label: "Framework", value: "Next.js 15 App Router" },
      { label: "AI Model", value: "fal.ai (restore + colorize)" },
      { label: "Design", value: "Canvas → Emil polish" },
      { label: "Skills used", value: "/design-html, /animate, /fal-restore, /fal-image-edit" },
    ],
  },
  {
    id: "ideaagent",
    ...
    vercelProject: "idea-agent",
    emoji: "💡",
    category: "AI Tools",
    tagline: "AI idea generator — validate startup ideas in seconds",
    accentColor: "#d97706",
    tips: [
    ...
    competitors: [
      { name: "Exploding Topics", url: "https://explodingtopics.com", strength: "Trend-backed idea discovery, B2B" },
      { name: "Ideanote", url: "https://ideanote.io", strength: "Team idea management, collaboration" },
      { name: "IdeaBuddy", url: "https://ideabuddy.com", strength: "Idea-to-business-plan pipeline" },
    ],
    featureToggles: [
      { key: "no_auth_generate", label: "Free Generate", description: "Generate ideas without account", defaultOn: true },
      { key: "validation_score", label: "Validation Score", description: "AI scores idea feasibility + market size", defaultOn: true },
      { key: "save_ideas", label: "Save Ideas", description: "Save and share idea lists", defaultOn: false },
    ],
    stack: [
      { label: "Framework", value: "Next.js 15 App Router" },
      { label: "AI Model", value: "llama-3.1-8b-instant (Groq)" },
